...
namespace food
{
    ...
    {
        internal static readonly string[] tags = { "Hiver", "Eté", "Fête", "Dessert", "Tartes/Tartines", "Viande", "Poulet", "Oeuf", "Poisson", "Légumes", "Riz/Pâtes", "Légumineuse","Ramadan soir", "Ramadan matin", "Soupe", "Boisson", "Snack", "Picnic","Petit déjuner", "Goüter" ,"Autres" };
