...
namespace food
{
    ...
    {
        internal static readonly string[] tags = { "Hiver", "Eté", "Fête", "Dessert", "Snack", "Viande", "Poulet", "Oeuf", "Poisson", "Légumes", "Riz/Pâtes", "Léguméneuse","Ramadan soir", "Ramadan matin", "Soupe", "Boisson", "Autres" };
