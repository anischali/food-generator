...
namespace food
{
    internal static class Generator
    {
        ...
        internal static readonly string[] contentTags = { "Proteine", "Légumes", "Légumineuse", "Produits Laitier", "Féculents", "Produits ménager", "Boisson", "Dessert","Fruits frais" ,"Fruits secs","Fruis oléagineux", "Epices","Autres" };
